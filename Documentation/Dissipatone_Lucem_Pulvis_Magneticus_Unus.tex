...
\begin{minipage}{0.8\textwidth}
	...
	We present a modeling program designed to simulate polarization and magnetic field morphologies of star-forming protoplanetary disk objects. Through modeling the properties of dust grain interactions with magnetic fields and light, Stokes parameters, measurements of polarization, which are normally observed can be simulated. The orientation of oblong shaped dust grains in protoplanetary regions is heavily influenced by the prevailing magnetic field. Dust grains influence observed polarization angles by reflecting with a vector aligned with the grain's longest axis. The magnetic field vectors are therefore aligned perpendicular to the polarization vectors. The simulation, generalized for any shape of cloud, magnetic field, density, or polarization factor function, allows for the generation of integrated 2D polarization maps. Comparing these 2D maps to observed data allows for fitting of model parameters to recreate the observed object's properties. 
