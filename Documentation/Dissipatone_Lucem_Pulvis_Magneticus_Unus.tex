...
\begin{minipage}{0.8\textwidth}
	...
	The orientation of oblong shaped dust grains in protoplanetary regions is heavily influenced by the prevailing magnetic field. Dust grains influence observed polarization angles by reflecting with a vector algined with the grain's longest axis. The magnetic field vectors are therefore algined perpendicular to the polarization vectors. We model/fit the magnetic field vectors, attempting to fit a simple magnetic field to the vectors. In this study, our simple magnetic field is some linear combination of hourglass shaped and circularlly shaped magnetic fields. 
